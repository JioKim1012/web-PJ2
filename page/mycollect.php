...
$sql = "SELECT * From travelimagefavor WHERE UID = '" . $_SESSION['UID'] . "'";
...
<div class="mypic">
    ...
    <table>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<form action="#">';
            echo '<a href="../src/deleteCollect.php?ImageID='.$rowImage['ImageID'].'"><input type="button" class="button" value="取消收藏" onclick="del()"></a>';
            echo '</form>';
            echo '</td>';
            echo '</tr>';
        }
